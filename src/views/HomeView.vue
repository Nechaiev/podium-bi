<template>
  ...
  <PopUpWrapper popupPosition="topRight">
    <template #body>
      <div>
        <div>
          <h5 class="text-title_5 mb-[30px]">Good work!</h5>
        </div>
        <div>
...
const accordionList = [
  {
    ...
    content: {
      description:
        "2. The Podium BI tool is the solution to removing the complexity of managing all of your Power BI content easily.",
  ...
  },
  {
    ...
    content: {
      description:
        "1. The Podium BI tool is the solution to removing the complexity of managing all of your Power BI content easily.",
  ...
  },
  {
    id: 3,
    title:
      "Want to manage and share content easily and do it all with just one Power BI license?",
    content: {
      description:
        "3. The Podium BI tool is the solution to removing the complexity of managing all of your Power BI content easily.",

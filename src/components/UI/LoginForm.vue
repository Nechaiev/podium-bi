  ...
  <section class="bg-white dark:bg-gray-900 rounded-lg">
    <div class="container flex items-center justify-center px-6 mx-auto">
      <form @submit.prevent="onSubmit" class="w-full max-w-md">
        <h2 class="text-[24px] mb-3 text-white mt-4">Log in</h2>
        ...
        <div class="flex button-row gap-4 pt-4 pb-4">
          <button @click="onCloseModal"
                  class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-cyan-900 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
            Close
          </button>
